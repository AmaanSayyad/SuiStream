...
const LiveChat = (props: Props) => {
  ...
  const commentFilter = superstream.contract.filters.CommentAdded(
    null,
    props?.topic,
    null
  );
  ...
  return (
    <div className="bg-gradient-to-t hidden hover:shadow-2xl shadow-purple-500 duration-200  relative p-4  from-slate-800 rounded-2xl to-transparent h-[480px] lg:flex flex-col">
      ...
      <div
        ...
        className="flex-1 h scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-700  h-full gap-2 overflow-y-scroll items-end flex flex-col"
      >
        {chats?.map((chat, i) => (
